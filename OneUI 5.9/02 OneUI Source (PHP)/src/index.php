    ...
    <div class="row g-0 justify-content-center text-center">
      <div class="col-md-10 pt-7 pb-5">
        ...
        <p class="fs-5 fw-medium text-muted mb-4 mx-xl-8">
          One super flexible UI framework for web developers and founders who value their time. Built with <span class="text-body-color fw-semibold">Bootstrap 5</span>, <span class="text-body-color fw-semibold">no jQuery</span> in core, now with a brand new <span class="text-body-color fw-semibold">dark mode</span>.
        </p>
    ...
    <div class="row py-5">
      ...
      <div class="order-md-0 col-md-7 d-flex align-items-center">
        <div>
          ...
          <a class="btn btn-primary m-1" data-toggle="click-ripple" href="https://pixelcave.com/products/oneui-vue-edition">
            Check it out
    ...
    <div class="py-5">
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-xl-4 py-3">
          ...
          <h4 class="mb-2">Laravel 11 Starter Kit</h4>
          <p class="text-muted">
...
<div id="one-call-to-action" class="bg-body-extra-light">
  <div class="content content-full">
    <div class="py-5 py-md-8 text-center">
      ...
      <p class="fs-lg fw-medium text-muted mb-4">
        Passionate web design and development with over 18,000 customers worldwide.
      </p>
